...
})({"g4Q1C":[function(require,module,exports,__globalThis) {
...
},{"./components/minesweeper":"gSdLp"}],"gSdLp":[function(require,module,exports,__globalThis) {
...
function revealOthers(id) {
    ...
    rowsToUpdate.forEach((row)=>{
        if (row >= 0 && row < x) columnsToUpdate.forEach((column)=>{
...
function updateFieldsValue(minesArray, r, c) {
    minesArray.forEach((mine)=>{
        ...
        rowsToUpdate.forEach((row)=>{
            if (row >= 0 && row < r) columnsToUpdate.forEach((column)=>{
                if (column >= 0 && column < c) {
                    if (Fields[row][column].isMine == false) Fields[row][column].updateValue();
                }
            });
        });
    });
...
function checkIfTheGameIsOver() {
    ...
    Fields.forEach((row)=>{
        row.forEach((field)=>{
            field.isMine ? mineCounter += 1 : field.revealed && (revealedCounter += 1);
        });
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"6k3Hc"}],"6k3Hc":[function(require,module,exports,__globalThis) {
...
},{}]},["g4Q1C","kyksZ"], "kyksZ", "parcelRequire94c2")

//# sourceMappingURL=saper.d29bb997.js.map
